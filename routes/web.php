...
Route::controller(SubscriptionsPlans::class)->group(function () {
    ...
    Route::get('/plano/assinar', 'create')->name('plano.assinar');
});

Route::controller(GetWayController::class)->group(function () {
    Route::get('/pay/create', 'createPlan')->name('pay.create');
});
